...
'sbg:revisionsInfo':
  ...
  - 'sbg:revision': 3
    ...
    'sbg:revisionNotes': Made renaming of clustering_evaluation* conditional on existence of file.
  - 'sbg:revision': 4
    'sbg:modifiedBy': mepstein
  ...
  - 'sbg:revision': 5
    ...
    'sbg:revisionNotes': >-
      Fixed phenotypic_file name -- changed all occurrences of "phenotypic" to
      "phenotype".
  - 'sbg:revision': 6
    'sbg:modifiedBy': mepstein
...
'sbg:appVersion':
  - 'sbg:draft-2'
id: >-
  https://cgc-api.sbgenomics.com/v2/apps/mepstein/knoweng-samples-clustering-dev/samples-clustering/11/raw/
